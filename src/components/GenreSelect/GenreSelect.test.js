...
describe('GenreSelect Component', () => {
  test('renders all genres passed in props', () => {
    ...
    render(<GenreSelect genres={genres} activeGenre="All" onSelect={jest.fn()} />);
  ...
  test('highlights the selected genre passed in props', () => {
    ...
    render(<GenreSelect genres={genres} activeGenre={activeGenre} onSelect={jest.fn()} />);
  ...
  test('calls "onSelect" callback with correct genre after a click event', () => {
    ...
    render(<GenreSelect genres={genres} activeGenre="All" onSelect={mockOnSelect} />);
